                    ...
                    child: Column(
                      children: [
                          ...
                          children: [
                            Container(
                              ...
                              child: Padding(
                                ...
                                child: Text("1",style: TextStyle(fontSize: 20,color: CustomColors.darkGreyTextColor),),
                              ),
                            ),
                            Container(
                              height: 1,
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(Dimens.dp_25),
                                child: Text("2",style: TextStyle(fontSize: 20,color: CustomColors.darkGreyTextColor)),
                              ),
                            ),
                            Container(
                              height: 1,
                            ...
                            Container(
                              ...
                              child: Padding(
                                padding: EdgeInsets.all(Dimens.dp_25),
                                child: Text("3",style: TextStyle(fontSize: 20,color: CustomColors.darkGreyTextColor)),
                              ),
                            )
                          ],
                        ),
                        ...
                        TextButton(
                          ...
                          child: Text(Strings.next,style: TextStyle(color: Colors.white,fontSize: 16),),
                        ),
                        SizedBox(height: 40,),
                      ],
                    )),
