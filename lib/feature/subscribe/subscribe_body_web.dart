...
class SubscribeBodyWeb extends StatefulWidget {
  @override
  SubscribeBodyWebState createState() => SubscribeBodyWebState();
}

class SubscribeBodyWebState extends BaseState<SubscribeBodyWeb> {
  String selectedItem = "";
